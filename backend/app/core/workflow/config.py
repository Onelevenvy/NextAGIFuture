...
new_config = {
    ...
    "nodes": [
        {
            "id": "start-1",
            "type": "start",
            "position": {"x": 63.925619834710744, "y": 211.53719008264463},
            "data": {"label": "Start"},
        },
        {
            "id": "llm-2",
            "type": "llm",
            "position": {"x": 396, "y": 178},
            "data": {"label": "LLM", "model": "glm-4", "temperature": 0.7},
        },
        {
            "id": "llm-3",
            "type": "llm",
            "position": {"x": 776, "y": 256},
            "data": {"label": "LLM", "model": "glm-4", "temperature": 0.7},
        },
        {
            "id": "tool-4",
            "type": "tool",
            "position": {"x": 932, "y": 128},
            "data": {"label": "Tool", "tools": ["calculator"]},
        },
        {
            "id": "end-5",
            "type": "end",
            "position": {"x": 1107, "y": 473},
            "data": {"label": "End"},
        },
    ],
    "edges": [
    ...
    "metadata": {
        "entry_point": "llm-2",
        "start_connections": [{"target": "llm-2", "type": "default"}],
        "end_connections": [{"source": "llm-3", "type": "smoothstep"}],
    },
}
