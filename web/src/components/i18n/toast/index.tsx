  ...
  return <div className={classNames(
    ...
    <div className="flex">
      <div className="flex-shrink-0">
        ...
        {type === 'warning' && <BsExclamationTriangleFill className="w-5 h-5 text-yellow-400" aria-hidden="true" />}
        {type === 'info' && <HiInformationCircle className="w-5 h-5 text-blue-400" aria-hidden="true" />}
      </div>
      <div className="ml-3">
        <h3 className={
          classNames(
